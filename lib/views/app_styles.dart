...
// Navbar Menu Items
const TextStyle navbarMenuItem = TextStyle(
  color: Colors.black,
  fontSize: 16,
);

// Hero Section
const TextStyle heroTitle = TextStyle(
  fontSize: 32,
...
const TextStyle heroSubtitle = TextStyle(
  fontSize: 20,
  color: Colors.white,
  height: 1.5,
);
...
const TextStyle boldPageText = TextStyle(fontSize: 16, color: Colors.black);
